/**
 * service-worker.js — Gerenciador de Pulso Espuladeira v8.0
 *
 * Estratégia:
 ...
 *
 * v8.0 CHANGELOG:
 * - Design System v8.0: identidade Black / Red / White
 * - CSS completo reconstruído com glass system refinado
 * - landing.html reconstruída: storytelling + Fibonacci + podcast player
 * - docs/manual.html e docs/mvp.html reconstruídos
 * - PDF templates: identidade preta/vermelha/branca
 * - Skills aplicadas: frontend-design, web-design-guidelines, shadcn, pdf
 */

const CACHE_VERSION   = 'gpe-v8.0.0';
