 ...
 * v6.0: + sincronização de cadastros base (tipos_fio, espulas) (RLS, 4xx) — não trata como "offline"
 * v8.0: Design System Fibonacci, glassmorphism, histórico 10 entradas
 */
'use strict';
  ...
  async upsert(ficha) {
    ...
    try {
      ...
      if (msg.toLowerCase().includes('row-level security') || msg.includes('42501')) {
        legivel = 'Permissão negada pelo banco de dados. Execute o SQL de configuração (SUPABASE_SETUP_v6.sql) no painel do Supabase.';
